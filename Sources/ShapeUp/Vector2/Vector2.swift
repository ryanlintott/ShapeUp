...
///
/// This type is mainly used internally so that `CGPoint` and `CGVector` are not publicly extended with too many functions that may conflict with other user functions.
