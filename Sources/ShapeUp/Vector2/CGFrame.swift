...
public extension CGFrame {
    ...
    /// Returns the point at the specified relative coordinates to the frame.
    ///
    /// Values outside the 0.0 to 1.0 range will project to relative positions outside the frame.
    /// - Parameters:
    ///   - x: The x-coordinate.
    ///   - y: The y-coordinate.
